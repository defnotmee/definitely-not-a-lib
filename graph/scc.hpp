...
(III) scc[i] < scc[j] => there is no path from i to j. [bonus from kosaraju]
...
you can just process the sccs in ascending order because of property (III)!
*/
